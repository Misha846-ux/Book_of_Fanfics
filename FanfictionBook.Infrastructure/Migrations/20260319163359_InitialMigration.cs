    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FanficEntityGenreEntity", x => new { x.FanficId, x.GenresId });
                    table.ForeignKey(
                        name: "FK_FanficEntityGenreEntity_Fanfics_FanficId",
                        column: x => x.FanficId,
                        principalTable: "Fanfics",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_FanficEntityGenreEntity_Genres_GenresId",
                        column: x => x.GenresId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FanficEntityGenreEntity_GenresId",
                table: "FanficEntityGenreEntity",
                column: "GenresId");
